---
description: Explore JavaScript SDK methods to customize and control your payment integration
---
...
This method attaches your Payment Element to the DOM. This only accepts a CSS selector (eg, #unified-checkout). You need to have created a DOM element in your HTML file where you think you can mount the Payment Element.
...
Register an event handler to be called when an event is triggered on the Payment Element.

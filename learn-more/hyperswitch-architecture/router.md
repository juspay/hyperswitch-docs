---
description: Understand the Router service architecture and core payment processing layer
---

# Router

The router service is implemented in Rust to ensure type safety and high performance. It follows a hexagonal architecture, promoting modularity by allowing independent management of different components.
...
* **Connector Module**: This module contains the logic to construct necessary request data for the selected services and to interpret their responses.

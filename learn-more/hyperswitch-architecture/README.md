...
In addition to the database, Juspay Hyperswitch incorporates Redis for two main purposes. It is used to cache frequently accessed data in order to decrease the application latencies and reduce the load on the database. It is also used as a queuing mechanism by the Scheduler.

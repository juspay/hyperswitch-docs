...
* [authorize](authorize-2.md) - Create initial authorization
* [capture](capture-2.md) - Complete payment instead of voiding
* [refund](refund-2.md) - Return funds after capture

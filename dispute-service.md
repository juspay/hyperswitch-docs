...
| [`get`](get-2.md)                      | Retrieve dispute status and evidence submission state. Tracks dispute progress through bank review process.      | Check dispute status, review evidence deadlines                  |
...
* [Payment Service](payment-service.md) - Review original payment details
* [Refund Service](refund-service.md) - Process voluntary refunds to avoid disputes
* [Event Service](event-service.md) - Handle dispute webhook notifications

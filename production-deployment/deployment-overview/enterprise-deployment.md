---
icon: building
description: Step-by-step guide for enterprise deployment of Juspay Hyperswitch on Kubernetes using Helm charts
---
...
In case you are setting up your Juspay Hyperswitch payments infrastructure on **Amazon Web Services** for the first time you can use **Hyperswitch's Terraform configuration files** to do so.
...
This is the most optimal setup for large-scale deployments.
{% endhint %}

...
| `mandate_id`              | string | Yes      | The mandate ID from setup\_recurring                  |
...
| `404`      | Mandate not found     | Verify mandate\_id is correct          |
| `409`      | Duplicate transaction | Use unique merchant\_transaction\_id   |
...
* [setup\_recurring](setup-recurring-2.md) - Create initial mandate
* [revoke](revoke-2.md) - Cancel recurring payments
* [Payment Service](payment-service-2.md) - Handle failed payment retries

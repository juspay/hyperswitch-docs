...
| `status`                 | string | AUTHENTICATION\_REQUIRED, FRICTIONLESS |
...
* [authenticate](authenticate-1.md) - Complete the 3DS flow
* [authorize](authorize-1.md) - Process payment with 3DS data

...
**Business Use Case:** After initiating 3DS with pre\_authenticate, this handles the actual authentication.
...
* [post\_authenticate](post-authenticate-2.md) - Validate results

...
{% hint style="info" %}
Here, you will be creating a Hyperswitch account and connecting your payment processor via your local host. The open source repositories for the Control Center will be available soon. In the mean time, we'll use cURL commands.
{% endhint %}

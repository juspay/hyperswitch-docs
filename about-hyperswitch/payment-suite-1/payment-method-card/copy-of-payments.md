---
description: Configure server-to-server vault tokenization to securely capture payment credentials and generate reusable tokens for future transactions
hidden: true

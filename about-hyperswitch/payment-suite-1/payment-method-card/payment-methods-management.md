---
description: Enable customers to securely save, view, manage, and delete stored payment methods for seamless checkout
icon: bars-progress
---
...
First, you'll need to set up your server to create payment method sessions, which establish secure connections between your frontend and the Juspay Hyperswitch Vault.

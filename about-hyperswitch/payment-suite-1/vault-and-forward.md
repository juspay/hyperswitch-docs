---
description: Securely vault payment credentials and forward transactions via proxy to reduce PCI compliance scope while maintaining existing processor integrations
hidden: true
---

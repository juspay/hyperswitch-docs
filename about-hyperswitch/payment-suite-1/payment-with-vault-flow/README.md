---
hidden: true
description: Understand the Payment with Vault flow to implement secure multi-processor payment orchestration with flexible vault integration and lifecycle management
---

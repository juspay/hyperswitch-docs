---
description: Understand the Payment with Vault Flow architecture and choose the optimal implementation pattern for your payment integration needs
hidden: true
---
...
* Every transaction is processed via a PSP, and based on the API calls you can have zero-dollar validation, multi-stage manual capture, or sophisticated recurring payment logic.

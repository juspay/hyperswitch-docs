---
description: Explore the Q2 2025 roadmap covering Vault, Authentication, Revenue Recovery, Intelligent Routing, Cost Observability, and Core Orchestration modules
icon: road
---
...
* Make Juspay Hyperswitch interoperable with any third party card vault.
* Merchants self-hosting Juspay Hyperswitch stack will be able to outsource PCI compliance as a managed service to Juspay Hyperswitch managed card vault, or other third party card vaults.
...
#### Intelligent Routing <a href="#intelligent-routing" id="intelligent-routing"></a>

* Making decision-engine a standalone offering to enable merchants to use it alongside any payment authorization system (vendor agnostic).
...
#### Cost Observability <a href="#cost-observability" id="cost-observability"></a>
...
#### Core Orchestration <a href="#core-orchestration" id="core-orchestration"></a>

---
description: Explore Q1 2025 roadmap covering modular payments, reconciliation, cost observability, revenue recovery, and new connector integrations
icon: road
---
...
### Recap of Q4 2024 <a href="#recap-of-q4-2024" id="recap-of-q4-2024"></a>

* [Dynamic Tax updater for express checkout wallets (PayPal, Applepay, Google Pay and Klarna) using Taxjar](https://docs.hyperswitch.io/explore-hyperswitch/e-commerce-platform-plugins/automatic-tax-calculation-for-express-checkout-wallets)
...
In Q1'25, Juspay Hyperswitch will be offering the following composable services as standalone modules on Juspay Hyperswitch SaaS version. This activity would be the major focus for the team and each of these modules address one or more of the above roadmap themes
...
* 🟧 **Reconciliation Service:** Reconciliation module will have an upgraded user experience; and allow FinOps teams to use the module independently without having to use Juspay Hyperswitch as the transaction processing technology _(Larger-scope initiative extending into Q2)_
...
* 🟧 Enhancing Juspay Hyperswitch's self-deployment process to be even more seamless and self-serve, enabling merchants to deploy a fully compliant payments stack independently _(Larger-scope initiative extending into Q2)_

...
## DeepWikis - AI-Powered Documentation
...
**Coverage:** All Juspay Hyperswitch related repositories including core payments switch, SDKs, infrastructure tools, and integrations

<details>

<summary>Available DeepWikis</summary>
...
## MCP Server - Direct API Integration

Execute real [Juspay Hyperswitch API](https://api-reference.hyperswitch.io/introduction) operations directly through your AI assistant using the [Model Context Protocol](https://modelcontextprotocol.io/introduction).

### What you can do:

- Make actual API calls to Juspay Hyperswitch sandbox through conversational AI

...
* Transaction reaches REFUNDED or PARTIALLY\_REFUNDED status
...
| `connector_refund_id` | string       | Connector's refund ID (e.g., re\_xxx)      |
...
* [get\_refund](get-7.md) - Check refund status
* [capture](capture-2.md) - Ensure payment is captured before refunding
* [Event Service](event-service-2.md) - Handle refund webhooks

# Surcharge Decision Manager

Hyperswitch Surcharge Decision Manager allows the merchant to configure advanced rules using various payment parameters such as amount, currency etc., to apply custom surcharge amounts to payments during confirm.

## How does it work?

* Hyperswitch supports surcharge via in multiple connectors.

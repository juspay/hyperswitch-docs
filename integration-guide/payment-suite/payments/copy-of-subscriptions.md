...
8. Failed MIT payments can be smartly retried by Hyperswitch ([read more](../../../other-features/payments-modules/revenue-recovery.md)) or by the solution provider of your choice.

...
Finally, you can pass the object of PaymentSheetParams to `initPaymentSheet` as shown in the previous [section](https://sites.gitbook.com/preview/site_gbSsq/~/revisions/Bk4ZQ060dHFoocGBrSEZ/integration-guide/payment-experience/payment/mobile/cross-platform/flutter/pages/ebHaowJXpQAe8i2eaL8X#id-3.3-collect-payment-details).

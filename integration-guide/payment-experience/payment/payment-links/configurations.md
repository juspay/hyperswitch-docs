...
Configure layout for the payment widget of the payment links. For a list of available options, refer to this section - [**SDK layouts**](../web/customization.md#id-1.-layouts).

...
* In the payment confirm response, there will be an additional field called "fingerprint". This is the fingerprint id that can be used to block a particular payment method. Use this to block the card.
...
7. [Unblock a fingerprint](https://api-reference.hyperswitch.io/v1/blocklist/delete-blocklist)
...
8. Block a Card BIN/ISIN (First 6 digits)
...
9. Block an ExtendedCardBin (First 8 digits)

...
Hyperswitch uses the proxy API of the external vault and passes the token. The external vault replaces the token with raw card data and sends the payment request to the PSP.

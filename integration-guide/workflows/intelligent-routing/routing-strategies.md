...
| [Multi-Objective Routing](multi-objective-routing.md) | You want to reduce processing cost without ignoring authorization performance. | Auth-Rate Routing and cost coverage. |
...
5. Add [Multi-Objective Routing](multi-objective-routing.md) once processor cost data is available.

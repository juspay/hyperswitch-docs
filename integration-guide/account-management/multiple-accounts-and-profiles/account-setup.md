...
{% content-ref url="../../../other-features/merchant-controls/integration-guide.md" %}
[integration-guide.md](../../../other-features/merchant-controls/integration-guide.md)
{% endcontent-ref %}

You can also refer to the [Smart Router](../../../other-features/payment-orchestration/smart-router.md) section to learn more about how you can route your payments and then later you can [Test a Payment](../../setup-hyperswitch-locally/test-a-payment.md).

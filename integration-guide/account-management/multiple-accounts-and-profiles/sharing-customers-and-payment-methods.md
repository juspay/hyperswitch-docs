...
* **The Platform API Key directly.** The platform configures the connector on behalf of the Connected Merchant. See [Programmatic onboarding flow](platform-organization-concepts.md#programmatic-onboarding-flow) for the API flow.

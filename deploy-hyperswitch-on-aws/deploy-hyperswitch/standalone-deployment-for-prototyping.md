---
description: Launch a standalone Hyperswitch deployment on AWS for prototyping and development testing using the standalone deployment for prototyping configuration.
---

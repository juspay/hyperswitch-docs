...
The mapper analyzes HTTP status codes, Error codes in the response body to map it to the appropriate Unified Code. A sample mapping of error codes across Stripe and Adyen as below.

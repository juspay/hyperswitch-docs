---
description: Initialize Barclaycard operations through the unified API to process payments through Barclaycard
---
...
#     barclaycard=payment_pb2.BarclaycardConfig(api_key=...),
# ))

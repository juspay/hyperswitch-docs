---
description: >-
  Initiate 3DS authentication flow to collect device data and prepare
  verification context
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/payment-method-authentication-service/pre-authenticate
---

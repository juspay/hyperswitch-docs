...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/payment-method-authentication-service
---
...
* [Payment Service](../payment-service.md) - Process payments after 3DS

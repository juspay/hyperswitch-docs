---
description: Set up recurring payment mandates for subscriptions and automated billing
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/setup-recurring
---
...
| `auth_type`                         | AuthenticationType | Yes      | Type of authentication to be used (e.g., THREE\_DS, NO\_THREE\_DS)     |
...
| `setup_future_usage`                | FutureUsage        | No       | Indicates future usage intention. Values: ON\_SESSION, OFF\_SESSION    |
...
* [RecurringPaymentService.Charge](../recurring-payment-service/) - Use the mandate for future recurring charges
* [Authorize](authorize.md) - Create initial charge with mandate
* [CustomerService.Create](../customer-service/) - Create customer for associated recurring payments

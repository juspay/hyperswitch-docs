...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/payment-service
---
...
| [`CreateOrder`](services/payment-service/create-order.md)  | Initialize an order in the payment processor system. Sets up payment context before customer enters card details for improved authorization rates.                       | Pre-checkout setup, session initialization                           |
...
* [Refund Service](refund-service/) - Process refunds and returns
* [Dispute Service](dispute-service/) - Handle chargebacks and disputes
* [Customer Service](customer-service/) - Manage customer payment methods

---
description: >-
  Reference all domain types, enums, and data structures used across Prism API
  services
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/domain-schema
---
...
| Domain Type                                                         | Description                   | Example                                                  | Related Types                                                                                                                                                                     |
| ------------------------------------------------------------------- | ----------------------------- | -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`ConnectorResponseData`](domain-schema/connector-response-data.md) | Connector response container. | `{"card": {...}, "extended_authorization": {...}}`       | [`CardConnectorResponse`](domain-schema/card-connector-response.md)                                                                                                               |
| [`CardConnectorResponse`](domain-schema/card-connector-response.md) | Card-specific response.       | `{"authentication_data": {...}, "card_network": "VISA"}` | [`ConnectorResponseData`](domain-schema/connector-response-data.md), [`AuthenticationData`](domain-schema/authentication-data.md), [`CardNetwork`](domain-schema/card-network.md) |

### Next Steps

* [Payment Service](payment-service/) - Core payment operations
* [Refund Service](refund-service/) - Refund processing
* [Dispute Service](dispute-service/) - Dispute management
* [Recurring Payment Service](recurring-payment-service/) - Recurring billing operations

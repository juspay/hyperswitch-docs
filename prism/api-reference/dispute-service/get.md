---
description: >-
  Retrieve dispute status and evidence submission details from the payment
  processor
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/dispute-service/get
---

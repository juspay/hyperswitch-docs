...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/customer-service/create
---
...
* [Authorize](../authorize.md) - Create a payment linked to this customer
* [PaymentMethodService.Tokenize](../tokenize.md) - Store payment methods for this customer
* [SetupRecurring](../setup-recurring.md) - Set up recurring billing with customer reference

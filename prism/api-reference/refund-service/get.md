...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/refund-service/get
---
...
* [Refund](../refund.md) - Initiate a new refund via Payment Service
* [Get Payment](../get.md) - Check the original payment status
* [Event Service](../event-service/) - Handle refund webhook notifications

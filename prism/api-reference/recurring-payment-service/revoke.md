...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/recurring-payment-service/revoke
---
...
| `connector_mandate_id` | string | No       | The connector's mandate ID (if different from mandate\_id) |
...
* [SetupRecurring](../setup-recurring.md) - Create new mandates if customer resubscribes
* [Refund](../refund.md) - Process refunds for unused subscription time

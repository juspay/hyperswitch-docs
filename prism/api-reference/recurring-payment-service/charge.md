...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/recurring-payment-service/charge
---
...
* [SetupRecurring](../setup-recurring.md) - Create initial mandate for new subscriptions
* [Get](../get.md) - Check status of pending charges

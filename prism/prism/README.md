---
description: >-
  Explore Hyperswitch Prism, a unified payment abstraction library enabling one
  integration to process payments across 100+ processors with zero lock-in
metaLinks:
  alternates:
    - https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/prism
---
...
_A high-performance payment abstraction library, and part of_ [_Juspay Hyperswitch_](https://hyperswitch.io/) _— the open-source, composable payments platform with 41k+ GitHub stars, trusted by leading brands worldwide._

---
description: >-
  Create payment orders with Stripe or Adyen to initialize checkout sessions for
  your customers
metaLinks:
  alternates:
    - /broken/spaces/kf7BGdsPkCw9nalhAIlE/pages/xIfMwTUwxrXLuBn9r6Xt
---
...
Create an order to get a `sessionToken` (session\_id, session\_data) from Adyen. The library will initiate the sessions API of Adyen.
...
* See [all payment flows](../getting-started/extending-to-more-flows.md)

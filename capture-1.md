...
* [Authorize](authorize-1.md) - Authorize a new payment (if additional charges needed)
* [Void](void-1.md) - Cancel an authorization instead of capturing
* [Refund](refund-1.md) - Return captured funds to customer

...
| `setupFutureUsage`          | FutureUsage       | No       | Future usage intent. Values: ON\_SESSION, OFF\_SESSION         |
...
| `authType`                        | AuthenticationType    | Authentication type used. Values: NO\_THREE\_DS, THREE\_DS                     |
...
* [Authorize](authorize-1.md) - Authorize a new payment

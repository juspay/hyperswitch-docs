...
| `authType`                        | AuthenticationType         | Yes      | Authentication flow type (e.g., THREE\_DS, NO\_THREE\_DS)       |
...
| `setupFutureUsage`                | FutureUsage                | No       | ON\_SESSION or OFF\_SESSION for tokenization                    |
...
| `connectorTransactionId`          | string              | Connector's transaction ID (e.g., Stripe pi\_xxx) |
...
* [Capture](capture-1.md) - Finalize the payment and transfer funds
* [Void](void-1.md) - Release held funds if order cancelled
* [Get](get-3.md) - Check current authorization status

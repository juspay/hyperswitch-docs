...
* [Payment Method Service](payment-method-service-2.md) - Store payment methods for customer
* [Payment Service](payment-service-2.md) - Process payments with customer ID
* [Recurring Payment Service](recurring-payment-service-2.md) - Set up subscriptions for customer

...
<!-- TODO: Add sample payload for `capture` in `scripts/connector-annotations/mollie.yaml` -->
...
<!-- TODO: Add sample payload for `tokenize` in `scripts/connector-annotations/mollie.yaml` -->

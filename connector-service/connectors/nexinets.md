...
<!-- TODO: Add sample payload for `capture` in `scripts/connector-annotations/nexinets.yaml` -->
...
<!-- TODO: Add sample payload for `void` in `scripts/connector-annotations/nexinets.yaml` -->

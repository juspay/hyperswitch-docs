---
description: Learn how Prism library is architected for multi-language SDKs and unified payment processing
---
...
|-----------|---------------|-------------------|--------------|
| **Interface layer** | Enabled developers to think in their language's patterns while using the unified payments grammar provided by the library | You use `client.payments.authorize()` with idiomatic types in your codebase | Node.js, Python, Java, .NET, Go, Haskell |
...
1. **Consistency**: The protobuf ensures same domain types, patterns, and errors shall be used across all connectors. It ensures the glue between the gRPC Client and the SDK interface.

...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- |
| [`get`](get-1.md) | Retrieve refund status from the payment processor. Tracks refund progress through processor settlement for accurate customer communication. | Checking refund status, reconciling refund states, customer inquiries |
...
* [Payment Service](payment-service.md) - Initiate refunds and process payments
* [Dispute Service](dispute-service.md) - Handle chargebacks that may result in refunds
* [Event Service](event-service.md) - Process asynchronous refund notifications

---
description: >-
  Set up  to start processing payments quickly
---
# Setup
...
1. To access the Juspay Saleor Payment App, [click here](https://live.Hyperswitch/saleor). You will be directed to a form where you can enter your Saleor API URL.

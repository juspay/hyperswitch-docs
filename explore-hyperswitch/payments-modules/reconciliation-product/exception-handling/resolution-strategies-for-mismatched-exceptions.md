---
description: Learn how to resolve MISMATCHED reconciliation exceptions in Juspay Hyperswitch using Ignore, Edit, Create, and Replace strategies to correct or void invalid transaction data.
---

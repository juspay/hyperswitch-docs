---
description: Understand all reconciliation statuses to track transactions from ingestion through posting and resolve exceptions efficiently using status-based workflows
---

...
You can [migrate from Stripe](../migrate-from-stripe/) to Juspay Hyperswitch in less than 15 mins and enable Paypal in a couple of clicks. Please follow the account setup (next section) to enable different payment methods of Stripe with Paypal.

---
description: Configure test credentials to validate payment flows and connector integrations in sandbox mode
icon: key
---
...
{% hint style="info" %}
This section gives you an overview of how you can make test transactions for the payment methods you have enabled
{% endhint %}

## Testing Cards across different Connectors

You might have configured multiple connectors on the Juspay Hyperswitch Dashboard. If you wish to ensure sanity of connector configuration, you can target and test the particular connector.

1. Log on to Juspay Hyperswitch Dashboard
2. Go to Smart Router > Simple Configuration
3. Add all the Gateways you wish to test and set highest priority to your target Gateway
4. Go to Home > Preview Checkout, to open the Unified Checkout (this will be a reflection of payment experience which your customer will get)
5. Enter card details as per the table below. Please note that test credentials vary across each connector

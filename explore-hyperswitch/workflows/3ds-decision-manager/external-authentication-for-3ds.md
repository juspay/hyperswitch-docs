---
description: Set up external 3DS authentication to use third-party 3DS servers with Hyperswitch processing using the external authentication for 3ds configuration.

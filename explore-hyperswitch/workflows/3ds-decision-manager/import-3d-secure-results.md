...
Importing 3DS results is an advanced payment flow that enables you to use external 3DS authentication with your Juspay Hyperswitch payments. Instead of running authentication within Juspay Hyperswitch, you can pass the completed authentication outcome directly into the payment flow.

---
description: Integrate the Vault SDK to enable secure payment method storage and retrieval in your application using the vault sdk integration 1 configuration.
hidden: true
icon: desktop
---

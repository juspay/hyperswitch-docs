---
description: >-
  Explore Activating FRM in Hyperswitch to enhance your payment orchestration capabilities
icon: shield-plus
---
# Activating FRM in Hyperswitch

You can enable the [FRM solution](https://juspay.in.io/integrations) of your choice with few clicks and very minimal code changes. Below are the two scenarios for activating FRM within Hyperswitch.

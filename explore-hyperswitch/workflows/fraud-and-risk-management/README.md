---
description: Configure fraud detection workflows to protect payments and minimize losses through real-time risk management
icon: shield-check
---

# Fraud & Risk Management

Juspay Hyperswitch Fraud and Risk Management (FRM) workflow offers a comprehensive Unified API designed to cater to your specific payment validation needs, effectively enhancing fraud protection within your payment ecosystem.

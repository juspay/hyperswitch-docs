...
hidden: true
icon: shield-check
description: Learn about 3D Secure (3DS) authentication, its benefits for fraud prevention, liability shift, and how Native 3DS enhances customer experience without redirections.
---
...
By providing a native 3DS experience, the users never leave the merchant app. It helps to reduce customer dropouts happening earlier because of confusing UX, time consuming loading screens and unoptimized flow.

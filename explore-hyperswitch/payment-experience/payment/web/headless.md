---
description: Integrate headless payment functionality to customize your checkout UI
...
if (paymentMethodSession.error) {
    ...
    // use the customer_default_saved_payment_method_data to fulfill your use cases (render UI)

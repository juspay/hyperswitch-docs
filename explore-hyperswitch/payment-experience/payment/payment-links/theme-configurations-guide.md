...
{% hint style="info" %}
**Important:** Custom terms and conditions can only be configured when using a custom domain for your payment links. By default, payment links are hosted on the Hyperswitch domain. To use custom domains and unlock the ability to set custom terms and conditions, please refer to our [Set up Custom Domain](setup-custom-domain.md) guide.
{% endhint %}
...
[**0 amount authorizations**](../../../authorizations/zero-amount-authorization-1.md) **(doing 0 amount auth (CIT) for future MITs):**

---
description: Explore Juspay Hyperswitch integration options for accepting payments online through customizable checkout UIs and SDKs
icon: sidebar-flip
---
...
[Use payment links](payment/payment-links/) to accept payments without building any integration onto a website or an app.

### Build a checkout

[Integrate the checkout](payment/web/) in your website and [customize](payment/web/customization.md) it as per your requirements.

### Build advanced integration

Use our [headless SDK](payment/web/headless.md) to have full control over your checkout while using the payment-related functionalities in a decoupled architecture.

### Build an in-app integration

Use our mobile SDK to accept payments in [Android](payment/mobile/android/) or [iOS](payment/mobile/ios/) apps.

### Build an APM-only integration

Use our [Alternate Payment Method widget](payment/enable-alternate-payment-method-widgets/) (APM widget) to power the global APMs in the unified format. This augments your existing checkout in a low code manner.

### Build a Vault SDK integration

Use our [Vault SDK](payment-method/) to tokenize the card first and then proceed with payment using a vault token. The Vault SDK is flexible to work with [Juspay Hyperswitch unified payments API](https://api-reference.hyperswitch.io/v1/payments/payments--create) as well as the [Proxy or forwarding](https://api-reference.hyperswitch.io/v2/proxy/proxy-v1) API of Juspay Hyperswitch

---
description: Learn how to process Apple Pay in-app and web transactions using PSP decryption, where the connector handles token decryption and authorization.
---

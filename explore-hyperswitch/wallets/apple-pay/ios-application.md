---
description: Enable Apple Pay on your iOS application to accept seamless wallet payments
hidden: true
icon: apple
---
...
2. Enter your details asked in the prompt. You will get a **.csr** and **.key** file
...
4. Select the iOS Certificate option

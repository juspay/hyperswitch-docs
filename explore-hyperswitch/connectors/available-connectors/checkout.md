...
{% hint style="info" %}
This section gives you an overview of how to make payments via Checkout through Juspay Hyperswitch
{% endhint %}
...
3. Request the Checkout support team to enable handling raw card data for your Checkout account via email (support@checkout.com). This will enable Juspay Hyperswitch to securely handle your customer's payment details.
...
[Steps](https://docs.hyperswitch.io/hyperswitch-cloud/connectors/activate-connector-on-hyperswitch) to activate Checkout on Juspay Hyperswitch control center.

---
description: Accept payments globally through Adyen via Hyperswitch, supporting cards, wallets, and local payment methods.
---
...
Adyen is a global payments company allowing businesses to accept payments on a global scale. It offers a variety of local and international payment methods. To know more about payment methods supported by Adyen via Hyperswitch, visit [here](https://hyperswitch.io/pm-list).

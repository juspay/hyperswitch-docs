...
{% hint style="info" %}
This section gives you an overview of how to make payments via Cybersource through Juspay Hyperswitch
{% endhint %}
...
[Steps](https://docs.hyperswitch.io/hyperswitch-cloud/connectors/activate-connector-on-hyperswitch) to activate Cybersource on Juspay Hyperswitch control center.

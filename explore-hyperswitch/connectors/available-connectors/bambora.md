...
{% hint style="info" %}
This section gives you an overview of how to make payments via Bambora through Juspay Hyperswitch
{% endhint %}
...
[Steps](https://docs.hyperswitch.io/hyperswitch-cloud/connectors/activate-connector-on-hyperswitch) to activate Bambora on Juspay Hyperswitch control center.

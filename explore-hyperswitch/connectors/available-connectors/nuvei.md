---
description: Integrate Nuvei to accept secure payments globally
hidden: true
---
...
Nuvei is a payment technology company that provides payment processing and acquiring services to merchants worldwide, with a focus on e-commerce and high-growth industries. To know about more about payment methods supported by Nuvei via Juspay Hyperswitch visit [here](https://hyperswitch.io/pm-list).
...
[Steps](https://docs.hyperswitch.io/hyperswitch-cloud/connectors/activate-connector-on-hyperswitch) to activate Nuvei on Juspay Hyperswitch control center.

---
description: Implement split settlements across multiple processors to distribute funds among different parties and manage marketplace revenue sharing seamlessly
icon: split
---

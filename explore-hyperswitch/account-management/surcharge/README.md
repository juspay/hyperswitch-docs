...
* Surcharge Decision Manager supports rules based on various payment parameters like payment\_amount, payment\_method, card\_network etc. Follow this [set up guide](surcharge-setup-guide.md) to configure rules using the Surcharge Decision Manager

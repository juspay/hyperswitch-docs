---
icon: cubes-stacked
description: Understand multi-tenancy architecture to manage multiple tenants with customized and logically isolated Hyperswitch stack environments
---

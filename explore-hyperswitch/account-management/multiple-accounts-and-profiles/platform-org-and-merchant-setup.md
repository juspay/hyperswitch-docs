---
description: Set up platform organization to programmatically onboard and manage multiple merchants
icon: garage-car
---
...
* Host exactly one Platform Merchant Account that can create and manage multiple Merchant Accounts, which can be either Standard or Connected.
...
Platform Merchant is the privileged parent merchant within a Platform Organization.
...
### Differences between Standard and Platform Organization

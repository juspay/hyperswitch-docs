...
You can use the Juspay Hyperswitch Dashboard to reveal, revoke, and create secret API keys. If you’re setting up Juspay Hyperswitch through a third-party platform (3PP), reveal your API keys in live mode to begin processing payments
{% endhint %}
...
You can see the list of payment processors already integrated with Juspay Hyperswitch. Click on the processor you want to connect.
...
2. Configure the Juspay Hyperswitch endpoint in the processor dashboard to receive webhooks
...
The Juspay Hyperswitch control center gives you full control on how and where you route your payments.
...
1. Volume based routing: As the name suggests, this routing is based on the volume provided. You can assign percentage volumes that needs to be processed with the connected processors and Juspay Hyperswitch will route in a way to ensure that the volume distribution is maintained

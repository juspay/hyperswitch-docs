---
icon: laptop-code
description: Embed pre-built white-labeled UI components into your application to integrate Hyperswitch payment orchestration seamlessly without redirecting users
---
...
Juspay Hyperswitch Embeds solves this. We provide a library of pre-built, fully white-labeled UI components that drop directly into your application. You get the full power of Hyperswitch's orchestration without ever sending your customers away.

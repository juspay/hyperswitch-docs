...
This option is unique to `EXPECTED` exceptions. It replaces the "Create Entry" workflow found in mismatches. Since the system is waiting for the right side to arrive, this action allows the user to say, _"Stop waiting. I have verified these funds myself."_

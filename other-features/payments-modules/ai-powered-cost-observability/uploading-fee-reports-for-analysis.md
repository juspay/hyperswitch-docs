---
description: >-
  Learn how to upload fee reports to Juspay Hyperswitch Cost Observability for
  analysis, enabling comprehensive cost monitoring and anomaly detection across
  payment processors
hidden: true
noIndex: true
metaLinks:
  alternates:
    - uploading-fee-reports-for-analysis.md
---
...
[Know more about Juspay Hyperswitch Reconciliation module and how to use it](../../../explore-hyperswitch/payments-modules/ai-powered-cost-observability/getting-started-with-recon.md).

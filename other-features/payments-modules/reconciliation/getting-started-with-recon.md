...
Records that don't fall under the purview of the above examples will need to be investigated with the respective teams (Juspay Hyperswitch, PSP or bank). We are also working on a feature that will enable you to track and close Reconciliation issues within the Reconciliation module (coming soon in future releases).

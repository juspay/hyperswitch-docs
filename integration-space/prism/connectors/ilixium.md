...
Source: data/field_probe/ilixium.json
Regenerate: python3 scripts/generators/docs/generate.py ilixium
-->
...
config = sdk_config_pb2.ConnectorConfig(
    ...
    connector_config=payment_pb2.ConnectorSpecificConfig(
        ilixium=payment_pb2.IlixiumConfig(
...
val config = ConnectorConfig.newBuilder()
    ...
    .setConnectorConfig(
        ConnectorSpecificConfig.newBuilder()
            .setIlixium(IlixiumConfig.newBuilder()
...
let config = ConnectorConfig {
    connector_config: Some(ConnectorSpecificConfig {
            config: Some(connector_specific_config::Config::Ilixium(IlixiumConfig {

...
| --------------------------------------------- | -------- | ----------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [**Network Proxy**](network-proxy.md)         | Token    | Routing to proxy URL; proxy detokenizes transparently                                     | <p><strong>VGS</strong>: URL-based routing (<code>tntxxx.sandbox.verygoodproxy.com</code>)<br><strong>Evervault</strong>: HTTP CONNECT relay with client-side encryption</p> |

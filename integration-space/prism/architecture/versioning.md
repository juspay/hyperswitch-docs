---
description: >-
  Understand Hyperswitch Prism's semantic versioning strategy to manage
  dependency updates and control feature rollouts safely
metaLinks:
  alternates:
    - /broken/spaces/kf7BGdsPkCw9nalhAIlE/pages/idYwyFeogtHErXZGrqGg
---
...
You may update minor versions intentionally when you need new connectors or features. Read the changelog, run your integration tests, and bump the pin.

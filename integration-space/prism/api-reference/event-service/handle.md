---
description: >-
  Process webhook notifications from connectors and parse them into standardized
  events
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/event-service/handle
---

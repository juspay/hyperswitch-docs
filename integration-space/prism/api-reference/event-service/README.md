---
description: >-
  Process webhook events from payment processors for real-time payment state
  updates
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/event-service
---
...
* [Payment Service](../payment-service/) - Handle payment success/failure events
* [Refund Service](../refund-service/) - Process refund completion events
* [Dispute Service](../dispute-service/) - Handle dispute notification events

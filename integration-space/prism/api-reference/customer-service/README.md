---
description: >-
  Create and manage customer profiles for streamlined payments and improved
  authorization rates
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/customer-service
---

...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference-overview/merchant-authentication-service-overview
---
...
* [Payment Method Service](../payment-method-service/) - Tokenize payment methods

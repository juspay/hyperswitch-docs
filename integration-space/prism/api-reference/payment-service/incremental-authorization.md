---
description: >-
  Increase the authorized amount on an existing authorization for hospitality
  and services
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/incremental-authorization
---

---
description: >-
  Authorize a payment to reserve funds on a customer payment method without
  capturing
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/authorize
---
...
| `auth_type`                         | AuthenticationType         | Yes      | Authentication flow type (e.g., THREE\_DS, NO\_THREE\_DS)       |
...
| `setup_future_usage`                | FutureUsage                | No       | ON\_SESSION or OFF\_SESSION for tokenization                    |
...
| `connector_transaction_id`          | string              | Connector's transaction ID (e.g., Stripe pi\_xxx) |

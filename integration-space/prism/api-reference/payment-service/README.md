...
metaLinks:
  alternates:
    - /broken/spaces/kf7BGdsPkCw9nalhAIlE/pages/J6aKmWcvrPlhmFjbvVF7
---
...
| [`CreateOrder`](/broken/pages/ff6F6HE45LDLI2uRrs5q)        | Initialize an order in the payment processor system. Sets up payment context before customer enters card details for improved authorization rates.                       | Pre-checkout setup, session initialization                           |

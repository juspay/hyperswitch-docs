...
metaLinks:
  alternates:
    - /broken/spaces/kf7BGdsPkCw9nalhAIlE/pages/ff6F6HE45LDLI2uRrs5q
---
...
* [MerchantAuthenticationService](../merchant-authentication-service.md) - Create session tokens for SDK integration

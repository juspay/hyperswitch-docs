---
description: Cancel an authorized payment to release held funds back to the customer
metaLinks:
  alternates:
    - https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/void
---
...
| `status`                            | PaymentStatus        | Current status. Values: VOIDED, VOID\_INITIATED, VOID\_FAILED |
| `error`                             | ErrorInfo            | Error details if status is VOID\_FAILED                       |

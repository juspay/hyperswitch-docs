---
description: >-
  Retrieve current payment status from the processor to synchronize your system
  state
metaLinks:
  alternates:
    - https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/get
---
...
| `setup_future_usage`           | FutureUsage       | No       | Future usage intent. Values: ON\_SESSION, OFF\_SESSION         |
...
| `auth_type`                         | AuthenticationType    | Authentication type used. Values: NO\_THREE\_DS, THREE\_DS                     |

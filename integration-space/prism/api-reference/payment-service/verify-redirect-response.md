---
description: >-
  Validate redirect-based payment responses to confirm authenticity and prevent
  fraud
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/verify-redirect-response
---

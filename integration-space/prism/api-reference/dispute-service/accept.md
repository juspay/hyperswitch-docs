---
description: >-
  Accept a chargeback dispute when evidence is insufficient or defense cost
  exceeds value
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/dispute-service/accept
---
...
* [Payment Service](../payment-service/) - Review original transaction

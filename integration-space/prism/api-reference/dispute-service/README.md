---
description: >-
  Manage chargeback disputes, submit evidence, and defend against fraudulent
  transaction claims
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/dispute-service
---
...
* [Payment Service](../payment-service/) - Review original payment details
* [Refund Service](../refund-service/) - Process voluntary refunds to avoid disputes
* [Event Service](../event-service/) - Handle dispute webhook notifications

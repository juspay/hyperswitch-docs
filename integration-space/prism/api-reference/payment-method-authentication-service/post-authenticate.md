---
description: >-
  Validate 3DS authentication results with the issuing bank before payment
  authorization
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/payment-method-authentication-service/post-authenticate
---
...
* [Payment Service](../payment-service/) - Authorize payment with 3DS data

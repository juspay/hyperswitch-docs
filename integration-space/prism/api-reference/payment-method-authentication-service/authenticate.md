---
description: >-
  Execute 3DS challenge or frictionless verification to authenticate the
  cardholder
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/payment-method-authentication-service/authenticate
---
...
* [Payment Service](../payment-service/) - Process payment with auth data

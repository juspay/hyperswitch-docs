---
description: >-
  Track and synchronize refund statuses across payment processors for customer
  communication
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/api-reference/refund-service
---
...
* [Payment Service](../payment-service/) - Initiate refunds and process payments
* [Dispute Service](../dispute-service/) - Handle chargebacks that may result in refunds
* [Event Service](../event-service/) - Process asynchronous refund notifications

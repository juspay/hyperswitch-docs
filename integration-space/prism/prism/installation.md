---
description: >-
  Install and configure the Hyperswitch Prism library for Node, Python, Java,
  and PHP payment processing
metaLinks:
  alternates:
    - https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/prism/prism/installation
---
...
That would be all. The SDK handles native library loading automatically. Start building in the [Quick Start](../getting-started/quick-start.md).

...
<!--
---
title: Eligibility (Java SDK)
description: Check the eligibility of a payout before initiating it. Using the Java SDK.
...
Response response = payoutClient.eligibility(request);
```

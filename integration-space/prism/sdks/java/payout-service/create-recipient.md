...
<!--
---
title: createRecipient (Java SDK)
description: Create a recipient entity for payouts. Using the Java SDK.
...
request.put("recipientType", "INDIVIDUAL");
request.put("amount", Map.of("minorAmount", 0, "currency", "USD"));

Response response = payoutClient.createRecipient(request);
```

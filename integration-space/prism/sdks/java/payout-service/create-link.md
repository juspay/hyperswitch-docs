...
<!--
---
title: createLink (Java SDK)
description: Create a link for the recipient to claim a payout. Using the Java SDK.
...
Response response = payoutClient.createLink(request);
```

...
<!--
---
title: enrollDisburseAccount (Java SDK)
description: Enroll an account for disbursement of funds. Using the Java SDK.
...
request.put("amount", Map.of("minorAmount", 0, "currency", "USD"));
request.put("payoutMethodData", Map.of("ach", Map.of("bankAccountNumber", "000123456789", "bankRoutingNumber", "110000000")));

Response response = payoutClient.enrollDisburseAccount(request);
```

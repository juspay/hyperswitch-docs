...
<!--
---
title: enrollDisburseAccount (PHP SDK)
description: Enroll an account for disbursement of funds. Using the PHP SDK.
...
$response = $payoutClient->enrollDisburseAccount($request);
```

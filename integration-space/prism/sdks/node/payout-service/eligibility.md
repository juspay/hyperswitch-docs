...
<!--
---
title: Eligibility (Node SDK)
description: Check the eligibility of a payout before initiating it. Using the Node.js SDK.
...
const response = await payoutClient.eligibility(request);
```

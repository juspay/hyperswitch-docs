---
icon: laptop
description: Install and run the Hyperswitch Control Center locally to manage payments through the visual interface
---
...
Follow these simple steps to set up Juspay Hyperswitch on your local machine.
...
4. Start the ReScript compiler:
   ...
   npm run re:start
   ```
5. In another terminal window, start the server, and SDK:
...
6. Update the config.toml file
   ...
   ```
   api_url = your-server-url #e.g: http://localhost:8080

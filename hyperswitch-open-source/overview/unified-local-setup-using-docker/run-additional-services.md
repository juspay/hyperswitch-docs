---
description: Run scheduler, monitoring, and data services to extend your Hyperswitch Docker setup
icon: arrows-to-circle
---

# Run additional services

The default behavior for docker compose only runs the following services:
...
Once the services have been confirmed to be up and running, you can proceed with [trying out the APIs](run-additional-services.md#try-out-the-apis).

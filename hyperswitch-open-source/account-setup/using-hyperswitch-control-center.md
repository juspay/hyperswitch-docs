---
description: Create your Juspay Hyperswitch account and add a payment provider via the control center
...
During the local setup of Juspay Hyperswitch, a user has been configured automatically for you. You can use following credentials to access the dashboard.

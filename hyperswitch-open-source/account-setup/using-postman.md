---
description: >-
  Create your Juspay Hyperswitch account and add a payment provider using Juspay Hyperswitch
...
## Create a Juspay Hyperswitch account <a href="#user-content-create-a-payment" id="user-content-create-a-payment"></a>
...
To generate an API key for your merchant account in Juspay Hyperswitch, follow these steps:

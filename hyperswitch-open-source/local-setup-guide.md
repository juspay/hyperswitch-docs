---
description: Explore local setup options for Juspay Hyperswitch using Docker or individual components to quickly start developing payment solutions
hidden: true
noIndex: true
icon: desktop
---
...
To quickly experience the ease that Hyperswitch provides while handling the payment, you can sign up on our [Dashboard](https://app.hyperswitch.io/), and try a payment.

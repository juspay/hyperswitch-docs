---
description: Deploy Hyperswitch payment infrastructure on AWS using full-stack or component-wise deployment options to customize your setup
icon: cloud
---

# Deploy on AWS

Hyperswitch can be deployed as an independent stack by leveraging the full-stack deployment solution. Alternatively, the component-wise section can be used to deploy within an existing stack using a customized format. Explore the details in each section for further information.

...
> ℹ️ **Info:** Explore the web client's full stack playground for rapid prototyping using a single script to experience the product before integrating it into your app. You can also test your deployment on cloud, CDN configurations, etc. with this demo playground, before deploying your app.
...
> **Note**
>
> You can directly start from [Step 3](#step-3-setup-hyperswitch-web-client-playground) if you have installed and configured AWS CLI
...
> ℹ️ **Info:** For more information, [click here](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html)
...
![AWS Security Credentials](../../../../.gitbook/assets/Screenshot%202023-10-12%20at%206.00.50%20PM.png)
...
> ℹ️ **Info:** You will either get these keys as an output when you host the app server, or for quick prototyping, you can create a new Hyperswitch sandbox account [here](https://app.hyperswitch.io/login) and get started.
...
> ⚠️ **Warning:** Depending on the API version and changes made to the web client, the web client may or may not be compatible with the SaaS app server.
...
> ✅ **Success:** That's it! Hyperswitch web client should be up and running on your AWS account
>
...
> ℹ️ **Info:** You need JQ installed for this. For more information, [click here](https://jqlang.github.io/jq/download/)

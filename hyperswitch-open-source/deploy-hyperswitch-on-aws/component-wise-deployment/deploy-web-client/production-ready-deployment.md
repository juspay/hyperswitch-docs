...
> ℹ️ **Info:** In this section, you will be deploying the web client on your AWS account
...
> **Note**
>
> You can directly start from [Step 3](#step-3-setup-juspay-hyperswitch-web-client) if you have installed and configured AWS CLI
...
![AWS Security Credentials](../../../../.gitbook/assets/image%20\(18\).png)
...
You can now deploy the Juspay Hyperswitch web client by running the below command in the same terminal session
...
Once the script is executed, you will receive a URL as the response (e.g. `http://my-bucket.s3.us-east-2.amazonaws.com/HyperLoader.js`). This is the base URL of your web client.

> ✅ **Success:** That's it! Juspay Hyperswitch web client should be up and running on your AWS account
>
...
[Integrate web client on your web app](integrate-web-client-on-your-web-app.md)

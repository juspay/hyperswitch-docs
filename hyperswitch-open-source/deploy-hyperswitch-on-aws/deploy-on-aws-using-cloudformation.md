...
The table below offers an estimated cost for operating the set up generated by the CDK script within your AWS environment. This cost is computed under the following assumptions:

---
description: Deploy Hyperswitch on AWS using CloudFormation CDK scripts to quickly set up a full-stack payment infrastructure with automated provisioning
icon: aws
---
...
| Hyperloader.js URL         | Use the `hyperloader` to [integrate the web client](component-wise-deployment/deploy-web-client/integrate-web-client-on-your-web-app.md) in your website |
| Demo App URL               | Test payments quickly using the Hyperswitch web checkout in the demo store                                                                                           |
...
2. **How do I deploy Hyperswitch on EKS using Helm charts?** Hyperswitch can be deployed on EKS by following the Helm chart documentation, which provides step-by-step instructions.
...
11. **How can I monitor the performance and health of Hyperswitch on EKS?** You can use AWS CloudWatch, Prometheus, or other monitoring solutions to track performance metrics and set up alerts. Refer to the [monitoring guide](../../production-deployment/going-live/for-on-prem-setup/monitoring.md) for more information.
...
13. **Are there any specific security considerations when deploying Hyperswitch on AWS EKS?** Follow the [best practices](../../production-deployment/going-live/for-on-prem-setup/security.md) for securing your EKS cluster and your Hyperswitch application, including network policies, IAM roles, and encryption.
...
15. **What do I do if I encounter issues during the deployment process?** If you encounter issues, consult the troubleshooting section of the documentation or [contact the support team](https://hyperswitch.io/contact) for assistance.
16. **Where can I find further documentation on Hyperswitch?** Additional documentation, tutorials, and support resources are available on the Hyperswitch website and in the API docs.

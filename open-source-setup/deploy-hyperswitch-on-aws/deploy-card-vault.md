...
If you're looking for a production grade deployment of the card vault to be used along with the Hyperswitch application, refer to the the [full-stack deployment guide ](deploy-app-server/full-stack-deployment.md)of Hyperswitch which includes the card locker as well.

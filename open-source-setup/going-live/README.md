...
* [ ] Aggregate your logs across instances and [setup a logging system](../../going-live/monitoring.md) (e.g. Grafana Loki) for storing and viewing your logs
...
* [ ] If you are storing card data make sure your [card vault is set up](../../going-live/pci-compliance/card-vault-installation.md) as per our instructions
...
* [ ] Make sure to follow our [security guidelines](../../going-live/security.md) for various components in your set up
...
* [ ] Keep track of new releases/bug fixes and make sure to [keep your system updated](../../going-live/updates.md)

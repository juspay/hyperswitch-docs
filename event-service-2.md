...
| ----------------------------------------------------------------- | --------------------------------------------------------------------------------------------- | ----------------------------------------------- |
| [`handle_event`](prism/sdks/python/event-service/handle-event.md) | Process webhook from payment processor. Verifies and parses incoming connector notifications. | Receiving webhook POST from Stripe, Adyen, etc. |
...
* [Payment Service](payment-service-2.md) - Handle payment webhooks
* [Refund Service](refund-service-2.md) - Process refund notifications
* [Dispute Service](dispute-service-2.md) - Handle dispute alerts

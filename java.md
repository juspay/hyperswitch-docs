...
| Service                                                                           | Description                                       |
| --------------------------------------------------------------------------------- | ------------------------------------------------- |
| [Payment Service](payment-service.md)                                             | Process payments from authorization to settlement |
| [Recurring Payment Service](recurring-payment-service.md)                         | Manage subscriptions and recurring billing        |
| [Refund Service](refund-service.md)                                               | Retrieve and track refund statuses                |
| [Dispute Service](dispute-service.md)                                             | Handle chargebacks and disputes                   |
| [Event Service](event-service.md)                                                 | Process webhook notifications                     |
| [Payment Method Service](payment-method-service.md)                               | Store and manage payment methods                  |
| [Customer Service](customer-service.md)                                           | Manage customer profiles                          |
| [Merchant Authentication Service](merchant-authentication-service.md)             | Generate access tokens                            |
| [Payment Method Authentication Service](payment-method-authentication-service.md) | 3D Secure authentication                          |
| [Payout Service](payout-service.md)                                               | Send funds to recipients                          |

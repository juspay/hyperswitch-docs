...
metaLinks:
  alternates:
    - integrate-web-client-on-your-web-app.md
---
...
The web client allows you to customize the appearance according to your web app for a better blended UI. Please check the [customization options](https://github.com/juspay/hyperswitch-docs/blob/atulp-hyperswitch-patch-1/self-hosting-space/integration-guide/payment-experience/payment/web/customization.md) for more details.

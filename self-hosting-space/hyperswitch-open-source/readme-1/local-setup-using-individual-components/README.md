...
### [**Hyperswitch App Server**](https://docs.hyperswitch.io):
...
### [**SDK (Frontend)**](https://docs.hyperswitch.io-web)**:**

The Hyperswitch SDK delivers a seamless and unified checkout experience across platforms:

* **Platform Support**: Available for [Web](https://docs.hyperswitch.io/explore-hyperswitch/merchant-controls/integration-guide/web), [Android, and iOS](https://docs.hyperswitch.io-client-core),.
...
### [**Control Center**](https://docs.hyperswitch.io-control-center):

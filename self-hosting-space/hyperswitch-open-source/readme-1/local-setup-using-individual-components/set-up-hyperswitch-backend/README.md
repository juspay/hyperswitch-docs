...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/kf7BGdsPkCw9nalhAIlE/hyperswitch-open-source/readme-1/local-setup-using-individual-components/set-up-hyperswitch-backend
---
...
{% content-ref url="configure-and-run-the-application.md" %}
[configure-and-run-the-application.md](configure-and-run-the-application.md)
{% endcontent-ref %}

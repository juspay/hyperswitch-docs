...
11. **How can I monitor the performance and health of Juspay Hyperswitch on EKS?** You can Use AWS CloudWatch, Prometheus, or other monitoring solutions to track performance metrics and set up alerts. Refer [our guide](../../path-to-production/going-live/for-on-prem-setup/monitoring.md) for more information
...
13. **Are there any specific security considerations when deploying Juspay Hyperswitch on AWS EKS?** You should follow our [best practices](../../path-to-production/going-live/for-on-prem-setup/security.md) for securing your EKS cluster and your Juspay Hyperswitch application, including network policies, IAM roles, and encryption.
14. **How do I upgrade Juspay Hyperswitch and its dependencies on EKS?** Please refer to the [Updates](../../path-to-production/going-live/for-on-prem-setup/updates.md) section for more details
